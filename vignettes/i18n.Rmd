...
* ![](figures/i18n/gb.svg){height=16} english, the default.

* ![](figures/i18n/fr.svg){height=16} french, activate with:

```{r}
options("datamods.i18n" = "fr")
```

* ![](figures/i18n/mk.svg){height=16} macedonian, activate with:

```{r}
options("datamods.i18n" = "mk")
```

* ![](figures/i18n/br.svg){height=16} ![](figures/i18n/pt.svg){height=16} brazilian portuguese, activate with:

```{r}
options("datamods.i18n" = "pt")
```

* ![](figures/i18n/al.svg){height=16} albanian, activate with:
